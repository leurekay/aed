...
R=Utils(df,'R1_delta','R2_delta','Statue_monitor')
plt.subplot(221)
R.plot(fig)

G=Utils(df,'G1_delta','G2_delta','Statue_monitor')
plt.subplot(222)
G.plot(fig)

B=Utils(df,'B1_delta','B2_delta','Statue_monitor')
plt.subplot(223)
B.plot(fig)
