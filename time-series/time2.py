...
plt.subplot(111)
plt.plot(index,df_rgb['R1'],'r')
plt.plot(index,df_rgb['G1'],'g')
plt.plot(index,df_rgb['B1'],'b')

plt.plot(index,df_rgb['R2'],'r',linewidth=3)
plt.plot(index,df_rgb['G2'],'g',linewidth=3)
plt.plot(index,df_rgb['B2'],'b',linewidth=3)
